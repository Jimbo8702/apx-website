...
/* Preserved hand-built quote form (mock-only — submit flips useState to a
   success message; nothing is sent). Replaced in <Quote /> by the live
   GoHighLevel embed (quote-embed.tsx) on 2026-06-08, kept here so it can be
   dropped back in if the embed ever needs to come out. Not currently rendered. */
    ...
    return (
      <div className="text-center py-[30px] px-2.5">
        ...
        <p className="text-muted">
          We&apos;ve got your request and will text you shortly with pricing and availability. In a
          hurry? Call{" "}
    ...
    >
      ...
      <label className="flex items-start gap-3 mb-5 cursor-pointer">
        ...
        <span className="text-muted text-[.85rem]">
          I consent to receive marketing text messages from {siteConfig.legalName} LLC at the phone
          number provided. Frequency may vary. Message &amp; data rates may apply.
        </span>
      </label>
